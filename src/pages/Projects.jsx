...
const projects = [
  {
    ...
    caseStudy: "insurance-portal",  // Match this path with the Route in AppRouter
  },
  {
    ...
    caseStudy: "smart-recon",  // Match this path with the Route in AppRouter
  },
  {
    ...
    caseStudy: "atm-monitoring",  // Match this path with the Route in AppRouter
  },
  {
    ...
    caseStudy: "vetro",  // Match this path with the Route in AppRouter
  },
  {
    ...
    caseStudy: "fito",  // Match this path with the Route in AppRouter
  },
];
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 h-0 group-hover:h-1/2 transition-all duration-500 ease-in-out bg-gray-800/40 backdrop-blur-md z-20 flex items-end pointer-events-none group-hover:pointer-events-auto">
              <div className="w-full flex justify-center mb-6 transform translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                {/* For View Details button, change <a> to <Link> */}
                <Link
                  to={`/dashboard/${caseStudy}`}  // This links to your project details page
