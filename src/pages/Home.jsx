...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-950 text-white">
      ...
      {/* Hero Section */}
      <motion.section
        className="pt-24 pb-20 px-6 md:px-16 relative overflow-hidden"
        initial="hidden"
        animate="visible"
        variants={fadeUp}
      >
        <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 via-gray-800 to-black -z-10 blur-lg" />
...
>
  ...
  />
          ...
          <div className="text-center md:text-left">
            <motion.h1 className="text-4xl md:text-6xl font-extrabold text-green-400 mb-4" variants={fadeUp}>
              Hi, I'm Tharun Vardhineni
            </motion.h1>
            <motion.p className="text-lg md:text-xl text-gray-300 mb-8 max-w-xl" variants={fadeUp} custom={1}>
              Full Stack Developer passionate about collaboration, clean design, and real-world impact.
            </motion.p>
            <motion.div className="flex justify-center md:justify-start" variants={fadeUp} custom={2}>
              <a
      ...
      {/* Flowchart Timeline */}
      <section className="overflow-x-auto py-16 px-6 md:px-16">
        <div className="flex gap-10 justify-center flex-wrap">
          {timeline.map((item, index) => (
            ...
            >
              {item.icon}
              <h3 className="mt-4 text-xl font-semibold text-green-300">{item.title}</h3>
              <p className="text-gray-400 text-sm">{item.subtitle}</p>
              <p className="text-sm text-gray-300 mt-2 leading-relaxed text-center">{item.description}</p>
      ...
      {/* Contact Section */}
      <motion.section
        className="bg-gray-900 px-6 md:px-16 py-16 text-center"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeUp}
      >
        ...
        <p className="text-gray-300 mb-6">Open to freelance, collaboration, and exciting new ideas.</p>
        <a
